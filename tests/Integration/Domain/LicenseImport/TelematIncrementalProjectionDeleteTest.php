...
final class TelematIncrementalProjectionDeleteTest extends TelematLicenseImportOrchestratorTestCase
{
    public function test_it_deletes_rows_missing_from_incremental_dataset(): void
    {
        ...
        Http::fake([
            '*' => Http::sequence()
                ->push(
                    $this->makeHtml([
                        ['LIC-001', 'Dupont', 'Jean', 'https://www.telemat.org/FFBI/sif/./?cs=del-1'],
                        ['LIC-002', 'Martin', 'Paul', 'https://www.telemat.org/FFBI/sif/./?cs=del-2'],
                        ['LIC-003', 'Durand', 'Luc', 'https://www.telemat.org/FFBI/sif/./?cs=del-3'],
                    ]),
                    200,
        ...
        $this->assertDatabaseHas('licencies', [
            ...
            'nom' => 'Dupont',
            'prenom' => 'Jean',
            'url' => 'https://www.telemat.org/FFBI/sif/./?cs=del-1',
        ]);
        ...
        $this->assertDatabaseHas('licencies', [
            ...
            'nom' => 'Durand',
            'prenom' => 'Luc',
            'url' => 'https://www.telemat.org/FFBI/sif/./?cs=del-3',
        ]);
        ...
        $this->assertSame(1, $projection['deleted_count'] ?? null);
