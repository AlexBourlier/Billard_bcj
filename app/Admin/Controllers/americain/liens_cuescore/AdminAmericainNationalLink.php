...
use \App\Models\AmericainNationalLink;
use App\Models\AmericainCalendrierNational;
use OpenAdmin\Admin\Controllers\AdminController;

class AdminAmericainNationalLink extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Lien CueScore américain national';
    ...
    {
        $grid = new Grid(new AmericainNationalLink());
...
JS);
    ...
    {
        $show = new Show(AmericainNationalLink::findOrFail($id));
    ...
    {
        $form = new Form(new AmericainNationalLink());
        ...
        if ($form->isCreating()) {
            ...
            $calendrier = AmericainCalendrierNational::find(request('calendrier_id'));
            if ($calendrier) {
        ...
        $form->saved(function (Form $form) {
            return redirect('/admin/americain-calendrier-nationals');
        });
