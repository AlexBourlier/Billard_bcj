...
use \App\Models\AmericainInternationalLink;
use App\Models\AmericainCalendrierInternational;
use OpenAdmin\Admin\Controllers\AdminController;

class AdminAmericainInternationalLink extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Lien CueScore américain international';
    ...
    {
        $grid = new Grid(new AmericainInternationalLink());
...
JS);
    ...
    {
        $show = new Show(AmericainInternationalLink::findOrFail($id));
    ...
    {
        $form = new Form(new AmericainInternationalLink());
        ...
        if ($form->isCreating()) {
            ...
            $calendrier = AmericainCalendrierInternational::find(request('calendrier_id'));
            if ($calendrier) {
        ...
        $form->saved(function (Form $form) {
            return redirect('/admin/americain-calendrier-internationals');
        });
