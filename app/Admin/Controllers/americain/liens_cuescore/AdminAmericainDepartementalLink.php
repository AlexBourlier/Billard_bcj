...
namespace App\Admin\Controllers\Americain\Liens_cuescore;

use OpenAdmin\Admin\Form;
use OpenAdmin\Admin\Grid;
use OpenAdmin\Admin\Show;
use OpenAdmin\Admin\Admin;
use \App\Models\AmericainDepartementalLink;
use App\Models\AmericainCalendrierDepartemental;
use OpenAdmin\Admin\Controllers\AdminController;

class AdminAmericainDepartementalLink extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Lien CueScore américain départemental';
    ...
    {
        $grid = new Grid(new AmericainDepartementalLink());
...
JS);
    ...
    {
        $show = new Show(AmericainDepartementalLink::findOrFail($id));
    ...
    {
        $form = new Form(new AmericainDepartementalLink());
        ...
        if ($form->isCreating()) {
            ...
            $calendrier = AmericainCalendrierDepartemental::find(request('calendrier_id'));
            if ($calendrier) {
        ...
        $form->saved(function (Form $form) {
            return redirect('/admin/americain-calendrier-departementals');
        });
