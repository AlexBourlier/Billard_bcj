...
use \App\Models\SnookerInternationalLink;
use App\Models\SnookerCalendrierInternational;
use OpenAdmin\Admin\Controllers\AdminController;

class AdminSnookerInternationalLink extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Lien CueScore snooker international';
    ...
    {
        $grid = new Grid(new SnookerInternationalLink());
...
JS);
    ...
    {
        $show = new Show(SnookerInternationalLink::findOrFail($id));
    ...
    {
        $form = new Form(new SnookerInternationalLink());
        ...
        if ($form->isCreating()) {
            ...
            $calendrier = SnookerCalendrierInternational::find(request('calendrier_id'));
            if ($calendrier) {
        ...
        $form->saved(function (Form $form) {
            return redirect('/admin/snooker-calendrier-internationals');
        });
