...
use \App\Models\SnookerDepartementalLink;
use App\Models\SnookerCalendrierDepartemental;
use OpenAdmin\Admin\Controllers\AdminController;

class AdminSnookerDepartementalLink extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Lien CueScore snooker départemental';
    ...
    {
        $grid = new Grid(new SnookerDepartementalLink());
...
JS);
    ...
    {
        $show = new Show(SnookerDepartementalLink::findOrFail($id));
    ...
    {
        $form = new Form(new SnookerDepartementalLink());
        ...
        if ($form->isCreating()) {
            ...
            $calendrier = SnookerCalendrierDepartemental::find(request('calendrier_id'));
            if ($calendrier) {
        ...
        $form->saved(function (Form $form) {
            return redirect('/admin/snooker-calendrier-departementals');
        });
