...
use \App\Models\CaramboleNationalLink;
use App\Models\CaramboleCalendrierNational;
use OpenAdmin\Admin\Controllers\AdminController;

class AdminCaramboleNationalLink extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Lien CueScore carambole national';
    ...
    {
        $grid = new Grid(new CaramboleNationalLink());
...
JS);
    ...
    {
        $show = new Show(CaramboleNationalLink::findOrFail($id));
    ...
    {
        $form = new Form(new CaramboleNationalLink());
        ...
        if ($form->isCreating()) {
            ...
            $calendrier = CaramboleCalendrierNational::find(request('calendrier_id'));
            if ($calendrier) {
        ...
        $form->saved(function (Form $form) {
            return redirect('/admin/carambole-calendrier-nationals');
        });
