...
namespace App\Admin\Controllers\carambole\Liens_cuescore;

use OpenAdmin\Admin\Form;
use OpenAdmin\Admin\Grid;
use OpenAdmin\Admin\Show;
use OpenAdmin\Admin\Admin;
use \App\Models\CaramboleDepartementalLink;
use App\Models\CaramboleCalendrierDepartemental;
use OpenAdmin\Admin\Controllers\AdminController;

class AdminCaramboleDepartementalLink extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Lien CueScore carambole départemental';
    ...
    {
        $grid = new Grid(new CaramboleDepartementalLink());
...
JS);
    ...
    {
        $show = new Show(CaramboleDepartementalLink::findOrFail($id));
    ...
    {
        $form = new Form(new CaramboleDepartementalLink());
        ...
        if ($form->isCreating()) {
            ...
            $calendrier = CaramboleCalendrierDepartemental::find(request('calendrier_id'));
            if ($calendrier) {
        ...
        $form->saved(function (Form $form) {
            return redirect('/admin/carambole-calendrier-departementals');
        });
