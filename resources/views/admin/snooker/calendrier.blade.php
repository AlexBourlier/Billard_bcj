...
<style>
    ...
    /* Style spécifique pour les calendriers - thème snooker */
    .calendar-section {
        background: linear-gradient(135deg, #1B5E20, #43A047); /* Vert foncé → Vert moyen */
    }
...
<div class="admin-grid">
    ...
    <div class="admin-card calendar-section calendar-pdf">
        <a href="{{ admin_url('snooker-calendriers') }}">
